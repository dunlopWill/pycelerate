...
def _check_name(name: str, n_args: int) -> None:
    ...
    raise TypeError(
        f"{upper} takes {wanted} argument{plural}, got {n_args}. "
        f"Pass check=False to override."
    )
...
_ARITY: dict[str, tuple[int, int | None]] = {
    # Aggregation
    "SUM": (1, None), "SUMIF": (2, 3), "SUMIFS": (3, None), "SUMPRODUCT": (1, None),
    "AVERAGE": (1, None), "AVERAGEIF": (2, 3), "AVERAGEIFS": (3, None),
    "COUNT": (1, None), "COUNTA": (1, None), "COUNTBLANK": (1, 1),
    "COUNTIF": (2, 2), "COUNTIFS": (2, None),
    "MIN": (1, None), "MAX": (1, None), "MAXIFS": (3, None), "MINIFS": (3, None),
    "SUBTOTAL": (2, None), "AGGREGATE": (3, None),
    "STDEV.S": (1, None), "STDEV.P": (1, None), "VAR.S": (1, None), "VAR.P": (1, None),
    "MEDIAN": (1, None), "MODE.SNGL": (1, None),

    # Arithmetic
    "ROUND": (2, 2), "ROUNDUP": (2, 2), "ROUNDDOWN": (2, 2), "MROUND": (2, 2),
    "ABS": (1, 1), "MOD": (2, 2), "INT": (1, 1), "TRUNC": (1, 2), "SIGN": (1, 1),
    "POWER": (2, 2), "SQRT": (1, 1), "EXP": (1, 1), "LN": (1, 1), "LOG": (1, 2),
    "LOG10": (1, 1), "CEILING.MATH": (1, 3), "FLOOR.MATH": (1, 3), "RAND": (0, 0),
    "RANDBETWEEN": (2, 2),

    # Logic
    "IF": (2, 3), "IFERROR": (2, 2), "IFNA": (2, 2), "IFS": (2, None),
    "AND": (1, None), "OR": (1, None), "NOT": (1, 1), "XOR": (1, None),
    "SWITCH": (3, None), "LET": (3, None),

    # Lookup
    "VLOOKUP": (3, 4), "HLOOKUP": (3, 4), "LOOKUP": (2, 3),
    "INDEX": (2, 4), "MATCH": (2, 3), "OFFSET": (3, 5), "INDIRECT": (1, 2),
    "CHOOSE": (2, None), "XLOOKUP": (3, 6), "XMATCH": (2, 4),
    "ROW": (0, 1), "COLUMN": (0, 1), "ROWS": (1, 1), "COLUMNS": (1, 1),

    # Dynamic arrays
    "FILTER": (2, 3), "SORT": (1, 4), "SORTBY": (2, None), "UNIQUE": (1, 3),
    "SEQUENCE": (1, 4), "TAKE": (2, 3), "DROP": (2, 3),
    "HSTACK": (1, None), "VSTACK": (1, None),

    # Text
    "TEXT": (2, 2), "LEN": (1, 1), "LEFT": (1, 2), "RIGHT": (1, 2), "MID": (3, 3),
    "TRIM": (1, 1), "UPPER": (1, 1), "LOWER": (1, 1), "PROPER": (1, 1),
    "SUBSTITUTE": (3, 4), "REPLACE": (4, 4), "FIND": (2, 3), "SEARCH": (2, 3),
    "CONCAT": (1, None), "CONCATENATE": (1, None), "TEXTJOIN": (3, None),
    "REPT": (2, 2), "VALUE": (1, 1), "NUMBERVALUE": (1, 3),
    "TEXTBEFORE": (2, 6), "TEXTAFTER": (2, 6), "TEXTSPLIT": (2, 6),

    # Dates
    "TODAY": (0, 0), "NOW": (0, 0), "DATE": (3, 3), "TIME": (3, 3),
    "YEAR": (1, 1), "MONTH": (1, 1), "DAY": (1, 1), "HOUR": (1, 1),
    "MINUTE": (1, 1), "SECOND": (1, 1), "WEEKDAY": (1, 2), "WEEKNUM": (1, 2),
    "EOMONTH": (2, 2), "EDATE": (2, 2), "DATEDIF": (3, 3), "DAYS": (2, 2),
    "YEARFRAC": (2, 3), "WORKDAY": (2, 3), "NETWORKDAYS": (2, 3), "DATEVALUE": (1, 1),

    # Finance
    "NPV": (2, None), "IRR": (1, 2), "XNPV": (3, 3), "XIRR": (2, 3),
    "PMT": (3, 5), "IPMT": (4, 6), "PPMT": (4, 6), "PV": (3, 5), "FV": (3, 5),
    "RATE": (3, 6), "NPER": (3, 5), "SLN": (3, 3), "PDURATION": (3, 3), "RRI": (3, 3),

    # Information
    "ISBLANK": (1, 1), "ISNUMBER": (1, 1), "ISTEXT": (1, 1), "ISERROR": (1, 1),
    "ISERR": (1, 1), "ISNA": (1, 1), "ISFORMULA": (1, 1), "ISLOGICAL": (1, 1),
    "NA": (0, 0), "ERROR.TYPE": (1, 1), "FORMULATEXT": (1, 1),
    "SHEET": (0, 1), "SHEETS": (0, 1), "CELL": (1, 2), "INFO": (1, 1),
}
