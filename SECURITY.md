...
If you find a security vulnerability in pycelerate, please report it through [GitHub's private vulnerability reporting](https://github.com/dunlopWill/pycelerate/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact willmdunlop@gmail.com for details.
